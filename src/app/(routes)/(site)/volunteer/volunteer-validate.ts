...
function answerField(min: number) {
  return z
    .string()
    .trim()
...
export const volunteerFormSchema = z.object({
  ...
  attendanceWeek: answerField(10),
  parentsComfort: answerField(10),
  campusHesitation: answerField(10),
  scenarioTaskConflict: answerField(20),
  scenarioPeerConduct: answerField(20),
  selectionReason: answerField(20),
});
