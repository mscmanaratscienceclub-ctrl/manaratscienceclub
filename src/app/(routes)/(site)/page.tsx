  ...
  return (
    <div className="relative">
      ...
      <section className="relative overflow-hidden bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-5 py-16 lg:px-8 lg:py-24">
          <div className="fade-up relative z-10 flex flex-col justify-center max-w-4xl">
            <div className="mb-7 inline-flex w-fit items-center gap-2 rounded-full border border-manara-teal/15 bg-cream px-4 py-2 font-display text-sm font-bold text-manara-teal">
            ...
            <h1 className="max-w-4xl font-display text-5xl font-bold leading-[0.98] tracking-tight text-manara-teal sm:text-6xl lg:text-7xl">
              Opportunities on<br />
              <span className="bg-gradient-to-r from-manara-yellow via-manara-teal to-manara-blue bg-clip-text text-transparent">what you dream</span>
            </h1>
            ...
            <div className="mt-12 grid max-w-2xl grid-cols-3 overflow-hidden rounded-[2rem] border border-manara-teal/10 bg-white shadow-subtle">
              <div className="p-5">
                <p className="font-display text-3xl font-bold text-manara-teal">450+</p>
              ...
              <div className="border-x border-manara-teal/10 p-5">
                <p className="font-display text-3xl font-bold text-manara-purple">30+</p>
                <p className="mt-1 text-xs font-semibold uppercase tracking-wide text-ink/50">Engineering Teams</p>
              </div>
              <div className="p-5">
                <p className="font-display text-3xl font-bold text-manara-pink">61</p>
      ...
      <section id="programs" className="bg-cream py-24">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="mb-12 grid gap-8 lg:grid-cols-[.8fr_1.2fr] lg:items-end">
            <div>
              <p className="font-display text-base font-bold text-manara-pink">Academic tracks</p>
          ...
          <div className="grid gap-6 lg:grid-cols-4">
            ...
            <article className="rounded-[2rem] border border-manara-teal/10 bg-white p-6 shadow-subtle transition hover:-translate-y-1 hover:shadow-academic">
              <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-manara-pink text-white"><Presentation className="h-7 w-7" /></div>
      ...
      <section className="py-12 md:py-16 relative overflow-hidden bg-white">
        <div className="absolute inset-0 opacity-40 bg-[radial-gradient(circle_at_20%_30%,rgba(255,183,3,0.2)_0%,transparent_50%),radial-gradient(circle_at_80%_70%,rgba(0,95,107,0.2)_0%,transparent_50%),linear-gradient(135deg,rgba(102,178,178,0.1)_0%,rgba(255,183,3,0.1)_100%)]"></div>
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black bg-gradient-to-r from-manara-yellow via-manara-teal to-manara-blue bg-clip-text text-transparent">Editorial</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <div className="group relative rounded-3xl overflow-hidden shadow-2xl transition-all duration-500 hover:shadow-[0_20px_50px_rgba(0,95,107,0.15)] hover:-translate-y-2 border-[3px] border-manara-yellow/40 bg-gradient-to-br from-manara-teal/5 to-transparent">
            ...
            <div className="group relative rounded-3xl overflow-hidden shadow-2xl transition-all duration-500 hover:shadow-[0_20px_50px_rgba(255,183,3,0.15)] hover:-translate-y-2 border-[3px] border-manara-teal/40 bg-gradient-to-br from-manara-yellow/5 to-transparent">
              <div className="p-6 md:p-7 bg-white/90 backdrop-blur-sm h-full flex flex-col justify-between">
                <div>
      ...
      <section className="py-16 md:py-20 bg-cream">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link
              href="/blogs"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full font-bold transition-all shadow-lg text-sm bg-manara-yellow text-white hover:-translate-y-1"
            >
      ...
      <section className="relative overflow-hidden bg-white px-5 py-24 lg:px-8">
        ...
        <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[3rem] bg-cream p-8 shadow-academic md:p-12 lg:p-16 border border-manara-teal/10">
          <div className="grid gap-10 lg:grid-cols-[1fr_.8fr] lg:items-center">
            <div>
              <p className="font-display text-base font-bold text-manara-teal">Enrollment process</p>
              ...
              <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                <Link href="/join" className="inline-flex items-center justify-center gap-3 rounded-full bg-manara-teal px-8 py-4 font-display text-base font-bold text-white shadow-academic transition hover:-translate-y-1 hover:bg-manara-yellow hover:text-manara-teal">
