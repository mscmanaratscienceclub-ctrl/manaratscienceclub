...
import { Atom, Menu, X, Bug } from "lucide-react";
    ...
    <header className="sticky top-0 z-40 border-b border-manara-teal/10 bg-white">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-8">
        ...
        <div className="flex items-center gap-3 lg:hidden">
          <Link href="/join" className="rounded-full bg-manara-teal px-4 py-2 font-display text-xs font-bold text-white">Join</Link>
