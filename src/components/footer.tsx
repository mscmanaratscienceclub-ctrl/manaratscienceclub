...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-manara-teal/20 bg-white">
      <div className="mx-auto max-w-7xl px-5 py-16 lg:px-8">
        <div className="grid gap-12 md:grid-cols-3">
          <div className="rounded-2xl bg-manara-teal/[0.04] p-6">
          ...
          <div className="rounded-2xl bg-manara-purple/[0.04] p-6">
          ...
          <div className="rounded-2xl bg-manara-red/[0.04] p-6">
            <p className="font-display text-xs font-bold uppercase tracking-widest text-manara-red">Community</p>
            <ul className="mt-6 space-y-4">
              ...
              <li><a href={siteConfig.social.boysCommunity} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm text-ink/70 hover:text-manara-yellow transition-colors"><Users className="size-4" />Brothers Group</a></li>
              <li><a href={siteConfig.social.girlsCommunity} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm text-ink/70 hover:text-manara-red transition-colors"><Users className="size-4" />Sisters Group</a></li>
            </ul>
          </div>
        </div>
        <div className="mt-14 flex flex-col items-start justify-between gap-3 pt-8 text-xs sm:flex-row sm:items-center">
          <div className="w-full rounded-xl bg-manara-teal/5 p-4">
            <div className="flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center">
              ...
              <p className="text-ink/40">Designed & built by <span className="font-semibold text-manara-teal">{siteConfig.developer}</span></p>
            </div>
          </div>
        </div>
      </div>
