...
<head>
  ...
  <title>Verify Your Email - ${data_1.siteConfig.name}</title>
</head>
          ...
          <tr>
            <td style="padding: 40px 32px;">
              ...
              <p style="font-size: 15px; line-height: 1.6; color: #4b5563; margin: 0 0 32px 0;">
                Thank you for signing up for ${data_1.siteConfig.name}! Please confirm your email address by clicking the button below.
              </p>
