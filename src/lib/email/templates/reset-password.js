...
<head>
  ...
  <title>Reset Your Password - ${data_1.siteConfig.name}</title>
</head>
          ...
          <tr>
            <td style="padding: 40px 32px;">
              ...
              <p style="font-size: 15px; line-height: 1.6; color: #4b5563; margin: 0 0 32px 0;">
                We received a request to reset the password for your ${data_1.siteConfig.name} account. Click the button below to choose a new one. This link expires in 15 minutes.
              </p>
